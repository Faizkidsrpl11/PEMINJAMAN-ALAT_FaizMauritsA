            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="
                        ...
                        @elseif(auth()->user()->role == 'petugas') {{ route('petugas.dashboard') }}
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->user()->role == 'admin')
                        ...
                        <x-nav-link :href="route('peminjaman.cetak')" :active="request()->routeIs('peminjaman.cetak')">
                            Cetak
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->role == 'admin')
                ...
                <x-responsive-nav-link :href="route('peminjaman.cetak')" :active="request()->routeIs('peminjaman.cetak')">
                    Cetak
                </x-responsive-nav-link>
